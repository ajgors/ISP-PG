...
HD_PWD='C:/Users/lab1/Desktop/lab5b/lab5b/lab5b.runs/singen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log singen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source singen.tcl
