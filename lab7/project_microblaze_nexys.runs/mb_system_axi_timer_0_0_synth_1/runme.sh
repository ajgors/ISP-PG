...
HD_PWD='C:/Users/lab1/Desktop/project_microblaze_nexys/project_microblaze_nexys.runs/mb_system_axi_timer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_system_axi_timer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_system_axi_timer_0_0.tcl
