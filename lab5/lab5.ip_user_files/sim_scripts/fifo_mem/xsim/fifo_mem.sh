...
#
# Script generated by Vivado on Sat Mar 29 13:53:07 +0100 2025
...
# script info
echo -e "fifo_mem.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L fifo_generator_v13_2_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_mem xil_defaultlib.fifo_mem xil_defaultlib.glbl -log elaborate.log
}
