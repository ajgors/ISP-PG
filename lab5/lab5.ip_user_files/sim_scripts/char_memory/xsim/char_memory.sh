...
#
# Script generated by Vivado on Sat Mar 29 13:42:20 +0100 2025
...
#
# Usage        : char_memory.sh
#                char_memory.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                char_memory.sh [-reset_run]
#                char_memory.sh [-reset_log]
#                char_memory.sh [-help]
#
...
# script info
echo -e "char_memory.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./char_memory.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot char_memory xil_defaultlib.char_memory xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb char_memory.wdb xsim.dir libdpi.so)
...
Usage: char_memory.sh [-step]\n\
Usage: char_memory.sh [-lib_map_path]\n\
Usage: char_memory.sh [-reset_run]\n\
Usage: char_memory.sh [-reset_log]\n\
Usage: char_memory.sh [-keep_index]\n\
